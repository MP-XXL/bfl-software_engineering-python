...
if command == "login":
    ...
    if user_name in user["username"]:
        ...
        if password == user["password"]:
            ...
            print(f"Password does not match for {user_name}")
    else:
        print(f"{user_name} does not exist in the database")
elif command == "register":
    user = {}
    user_name = input("Enter your prefered username : ")
    if user_name not in user:
        password = input("Enter your prefered password : ")
        user_balance = float(input("Enter amount you wish to fund your account : "))
        ...
        if verification_action == "yes":
            if user["balance"] >= verification_amount:
                ...
                print("Verification updated successfuly!")
            else:
                print("Insufficient funds! balance : ", user["balance"])
                print(f"Verification costs : ", verification_amount)
        elif verification_action == "no":
            pass
        else:
